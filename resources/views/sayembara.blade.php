                    ...
                    <table class="mx-auto">
                        ...
                        <tr>
                            <td class="pt-2">
                                ...
                                <div class="pendaftaranbutton" style="cursor: pointer;" onclick="location.href='https://docs.google.com/forms/d/e/1FAIpQLScXJy7SSsisq9yAry52qtUoREDd7IcheBjMSqZREeOTxHJkXg/viewform?usp=pp_url'"><p class="d-flex align-items-center justify-content-center" style="line-height: 50px; color: white;">PENDAFTARAN</p></div>
                                <div class="lpo_button capsulebutton d-flex align-items-center justify-content-center" style="cursor: pointer; background: #686d5f; border-radius: 80px; height: 50px; width: 100%;" onclick="location.href='{{route('dllaporan')}}'"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download text-white ms-2" viewBox="0 0 16 16">
                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
                                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
                                  </svg><div class="ms-2 text-white" style="color: white;">LEMBAR ORISINALITAS</div></div>
                                </div>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="mx-auto">
                        ...
                        <tr>
                            <td class="pt-2">
                                ...
                                <div class="pendaftaranbutton" style="cursor: pointer;" onclick="location.href='https://docs.google.com/forms/d/e/1FAIpQLSf2vhSxQnsNBpSV_nuIT29oziAm5jwYAd2r6U8MxQwOi3qnoA/viewform?usp=pp_url'"><p class="d-flex align-items-center justify-content-center" style="line-height: 50px; color: white;">PENDAFTARAN</p></div>
                                <div class="lpo_button capsulebutton d-flex align-items-center justify-content-center" style="cursor: pointer; background: #686d5f; border-radius: 80px; height: 50px; width: 100%;" onclick="location.href='{{route('dllaporan')}}'"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download text-white ms-2" viewBox="0 0 16 16">
                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
                                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
                                  </svg><div class="ms-2 text-white" style="color: white;">LEMBAR ORISINALITAS</div></div>
                    ...
                    <table class="mx-auto">
                        ...
                        <tr>
                            <td class="pt-2">
                                ...
                                <div class="pendaftaranbutton" style="cursor: pointer;" onclick="location.href='https://docs.google.com/forms/d/e/1FAIpQLSfGdICls_orjz1ZIzGf-aKTMlG8GJe4pmSncxm8j2wGOZsZKg/viewform?usp=pp_url'"><p class="d-flex align-items-center justify-content-center" style="line-height: 50px; color: white;">PENDAFTARAN</p></div>
                                <div class="lpo_button capsulebutton d-flex align-items-center justify-content-center" style="cursor: pointer; background: #686d5f; border-radius: 80px; height: 50px; width: 100%;" onclick="location.href='{{route('dllaporan')}}'"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download text-white ms-2" viewBox="0 0 16 16">
                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
                                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
                                  </svg><div class="ms-2 text-white" style="color: white;">LEMBAR ORISINALITAS</div></div>
            ...
            <div class="mx-xxl-5 px-xxl-5 my-5 py-5">
                <div class="mx-xxl-5 px-xxl-5">
                    <table class="mx-auto">
                        ...
                        <tr>
                            <td>
                                <p class="textjustify">Sayembara Desain Ilustrasi dibuka untuk umum, baik untuk warga Kota Surabaya maupun dari luar Kota Surabaya. Dengan tema yang diangkat yakni seputar Kebudayaan Surabaya, sayembara ini dapat diikuti secara individu.</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="pt-2">
                                <div class="d-flex justify-content-evenly">
                                    <div class="pendaftaranbutton" style="cursor: pointer;" onclick="window.location='https://docs.google.com/forms/d/e/1FAIpQLSf5LwVaFm1Wt8oz3oHcCI3niG6_xzrixRb_S6MyeoFrN7NJ6g/viewform?usp=pp_url'"><p class="d-flex align-items-center justify-content-center" style="line-height: 50px; color: white;">PENDAFTARAN</p></div>
