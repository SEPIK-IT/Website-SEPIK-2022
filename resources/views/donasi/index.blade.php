...
<button id="tooglebar" onclick="openNav()"
        style="background-color: transparent; z-index: 0; position: absolute; margin-left: 10%; margin-top: 5%;"><i
    ...
    <section class="py-5 text-center container">
        <div class="row pt-lg-5 pb-lg-2">
            <div class="col-lg-6 col-md-8 mx-auto">
                ...
                <p>
                    <!-- donate  -->
                    <a href="{{route('donate.create')}}" class="btn btn-sepik my-2">DONASI SEKARANG</a>
